...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      sidebar_mode_toggle: z.string().optional().default("ctrl+b").describe("Toggle sidebar mode (info/code)"),
      sidebar_up: z.string().optional().default("up,k").describe("Navigate up in sidebar file list"),
      ...
      sidebar_width_increase: z.string().optional().default("ctrl+shift+right").describe("Increase sidebar width"),
      sidebar_width_decrease: z.string().optional().default("ctrl+shift+left").describe("Decrease sidebar width"),
      ...
      file_explorer: z.string().optional().default("ctrl+shift+f").describe("Open file explorer"),
    })
    .strict()
    .meta({
      ref: "KeybindsConfig",
